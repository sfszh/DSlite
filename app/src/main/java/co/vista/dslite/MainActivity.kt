...
//                        ?: throw IllegalStateException("field $PAGE_URL missing in Intent")
        pageUrl = "http://ak503new.nz.vm/VistaDigitalSignagePlayer/#/start?screenHostDeviceName=abc6bb906bd60673-898b2c6e51784b3d856bcc794218525c&ipAddress=172.17.13.67&screenNumber=1"
        initWebView()
        setWebClient()
        handlePullToRefresh()
        loadUrl(pageUrl)
